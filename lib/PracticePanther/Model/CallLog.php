 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CallLog implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CallLog';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['call_direction'], $allowedValues)) {
     ...
     * Sets call_direction
     *
     * @param string $call_direction call_direction
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getCallDirectionAllowableValues();
        if (!is_null($call_direction) && !in_array($call_direction, $allowedValues)) {
